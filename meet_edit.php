...
*/
  ...
  <div class='input-form' style="text-align:center">
    <form name='form' method='post' action='meet_update.php?mid=<?php echo $mid ?>'>
      <!-- <div class="row"> -->
      <div class="col">
        <label for="title" class="meetdate" style="width: 200px;height: 30px;">會議日期</label>
        <input type='meetdate' name='meetdate' placeholder="會議日期" style="width: 600px;height: 30px;"
          value=<?php echo  $row['meetdate'] ?>>
      </div>
      <div class="col">
